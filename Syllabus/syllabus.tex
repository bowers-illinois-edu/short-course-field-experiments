...
\classnum{EUI Swiss Chair \& Dept of Political and Social Science  \\ 3rd Term Workshop 2021}

%%%%%%%%%%%%%%% PROF INFO
\profname{Jake Bowers}
\officehours{Zoom Office Hours: \href{https://calendly.com/jakebowers/eui-office-hours}{https://calendly.com/jakebowers/eui-office-hours}}
%\office{Zoom}
...
\classloc{Classes via Zoom}
\classinfo{Course platform: Campuswire}
...
\qOne{Is this the final version of the syllabus?}
\aOne{No. This is a new class. I will post new versions on Campuswire as we go.}

\qTwo{How many credits is this workshop worth?}
\aTwo{This workshop is worth 10 credits.}

%\qThree{Where can I get the books and articles?}
%\aThree{If you don't mind pdf versions, many University libraries make these available.}
